...
public class FindDoctorBean {
    ...
    /**
     * result : [{"badNum":0,"departmentId":2,"departmentName":"骨科","doctorId":2,"id":1298,"imagePic":"http://172.17.8.100/images/health/doctor/system_image_pic/system_image2.jpg","inauguralHospital":"三甲","jobTitle":"主治医师","name":"安安","number":33,"praise":"100.00%","praiseNum":2}]
     * message : 查询成功
     * status : 0000
     */
