...
import com.wd.login.view.RetrofitManager;
...
public class LoginModel implements LoginContract.Imodel {
    ...
    @Override
    public void putForgetModel(String email, String pwd1, String pwd2, IMoldelForgetCallBack iMoldelForgetCallBack) {
        if (NetUtil.hasNetwork(BaseApp.getAppContext())) {
            RetrofitManager.getInstance().create(ApiServer.class)
    ...
    @Override
    public void postCheckCodeModel(String email, String code, IMoldelCheckCodeCallBack iMoldelCheckCodeCallBack) {
        if (NetUtil.hasNetwork(BaseApp.getAppContext())) {
            RetrofitManager.getInstance().create(ApiServer.class)
