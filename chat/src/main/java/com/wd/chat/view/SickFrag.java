    ...
    protected void initView() {
        ...
        tablayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (position==0){
                    mPresenter.DoctorP(departmentId, 1, 0, page, 4);
                }
                if (position==1){
                    mPresenter.DoctorP(departmentId, 2, 0, page, 4);
                }
                if (position==2){
                    mPresenter.DoctorP(departmentId, 3, 0, page, 4);
                }
                if (position==3){
                    mPresenter.DoctorP(departmentId, 4, 0, page, 4);
                }
            }
