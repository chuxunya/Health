...
/**
 * @describe(描述)：SynthesisFrag
 * @data（日期）: 2019/12/16
 * @time（时间）: 10:45
 * @author（作者）: xin
 **/
public class SynthesisFrag extends BaseFragment<InquiryPresenter> implements Contract.IView {

    private static final String TAG = "SynthesisFrag";
    @BindView(R.id.img)
    ImageView img;
    @BindView(R.id.name)
    TextView name;
