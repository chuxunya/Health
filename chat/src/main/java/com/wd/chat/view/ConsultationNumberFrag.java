...
/**
 * @describe(描述)：ConsultationNumberFrag
 * @data（日期）: 2019/12/16
 * @time（时间）: 10:47
 * @author（作者）: xin
 **/
public class ConsultationNumberFrag extends BaseFragment<InquiryPresenter> implements Contract.IView {
    ...
    protected int provideLayoutId() {
        return R.layout.fragment_consultation_number;
    }
