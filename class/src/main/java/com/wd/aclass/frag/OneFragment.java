...
public class OneFragment extends BaseFragment<JiangtangPresenter> implements JiangtangContract.Iview {
    ...
    protected void initData() {
        ...
        mPresenter.JiangVideo("435","1576651114347435","1","1","5");
    ...
    public void JiangVideo(VideoBean videoBean) {
        ...
        player_one.setLayoutManager( layoutManager );
        player_one.setAdapter( tikTokAdapter );
    ...
    private void startPlay(int position) {
        View itemView = player_one.getChildAt(0);
