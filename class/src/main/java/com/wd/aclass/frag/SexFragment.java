...
public class SexFragment extends BaseFragment<JiangtangPresenter> implements JiangtangContract.Iview {
    ...
    protected void initData() {
        ...
        mPresenter.JiangVideo("435","1576651114347435","6","1","5");
    ...
    public void JiangVideo(VideoBean videoBean) {
        ...
        player_sex.setLayoutManager( layoutManager );
        player_sex.setAdapter( tikTokAdapter );
    ...
    private void startPlay(int position) {
        View itemView = player_sex.getChildAt(0);
