...
public class FiveFragment extends BaseFragment<JiangtangPresenter> implements JiangtangContract.Iview {
    ...
    protected void initData() {
        ...
        mPresenter.JiangVideo("435","1576651114347435","5","1","5");
    ...
    public void JiangVideo(VideoBean videoBean) {
        ...
        player_five.setLayoutManager( layoutManager );
        player_five.setAdapter( tikTokAdapter );
    ...
    private void startPlay(int position) {
        View itemView = player_five.getChildAt(0);
